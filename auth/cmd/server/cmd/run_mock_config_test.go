...
// Source: github.com/vskurikhin/DayBook3/auth/v2/cmd/server/cmd (interfaces: Config)
//
// Generated by this command:
//
//	mockgen -destination=run_mock_config_test.go -package=cmd github.com/vskurikhin/DayBook3/auth/v2/cmd/server/cmd Config
//
