...
/**
 * Reactive synchronization trigger for value record operations.
 *
 * <p>
 * This component is responsible for notifying the
 * {@link RecordSchedulerService} whenever a value record
 ...
 */
@ApplicationScoped
public class ValueRecordSyncTrigger implements Consumer<ResourceValueRecord> {

    private static final Logger LOG = Logger.getLogger(ValueRecordSyncTrigger.class);
    ...
    /**
     * Triggers synchronization after a successful value resource operation.
     *
     * <p>
     ...
     * </p>
     *
     * @param resource the value resource associated with the operation
     */
    @Override
    public void accept(ResourceValueRecord resource) {
