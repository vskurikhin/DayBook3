...
/**
 * Reactive synchronization trigger for XML record operations.
 *
 * <p>
 * This component is responsible for notifying the
 * {@link RecordSchedulerService} whenever a XML record
 ...
 */
@ApplicationScoped
public class XmlRecordSyncTrigger implements Consumer<ResourceXmlRecord> {

    private static final Logger LOG = Logger.getLogger(XmlRecordSyncTrigger.class);
    ...
    /**
     * Triggers synchronization after a successful XML resource operation.
     *
     * <p>
     ...
     * </p>
     *
     * @param resource the XML resource associated with the operation
     */
    @Override
    public void accept(ResourceXmlRecord resource) {
