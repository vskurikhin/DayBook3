...
/**
 * Reactive synchronization trigger for set of text record operations.
 *
 * <p>
 * This component is responsible for notifying the
 * {@link RecordSchedulerService} whenever a set of text record
 ...
 */
@ApplicationScoped
public class SetRecordSyncTrigger implements Consumer<ResourceSetRecord> {

    private static final Logger LOG = Logger.getLogger(SetRecordSyncTrigger.class);
    ...
    /**
     * Triggers synchronization after a successful set of text resource operation.
     *
     * <p>
     ...
     * </p>
     *
     * @param resource the set of text resource associated with the operation
     */
    @Override
    public void accept(ResourceSetRecord resource) {
