 ...
 * MarkdownRecordSyncTrigger.java
 * $Id$
 */
...
/**
 * Reactive synchronization trigger for markdown record operations.
 *
 * <p>
 * This component is responsible for notifying the
 * {@link RecordSchedulerService} whenever a markdown record
 ...
 */
@ApplicationScoped
public class MarkdownRecordSyncTrigger implements Consumer<ResourceMarkdownRecord> {

    private static final Logger LOG = Logger.getLogger(MarkdownRecordSyncTrigger.class);
    ...
    /**
     * Triggers synchronization after a successful markdown resource operation.
     *
     * <p>
     ...
     * </p>
     *
     * @param resource the markdown resource associated with the operation
     */
    @Override
    public void accept(ResourceMarkdownRecord resource) {
