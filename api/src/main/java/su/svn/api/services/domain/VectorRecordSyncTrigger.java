...
/**
 * Reactive synchronization trigger for vector record operations.
 *
 * <p>
 * This component is responsible for notifying the
 * {@link RecordSchedulerService} whenever a vector record
 ...
 */
@ApplicationScoped
public class VectorRecordSyncTrigger implements Consumer<ResourceVectorRecord> {

    private static final Logger LOG = Logger.getLogger(VectorRecordSyncTrigger.class);
    ...
    /**
     * Triggers synchronization after a successful vector resource operation.
     *
     * <p>
     ...
     * </p>
     *
     * @param resource the vector resource associated with the operation
     */
    @Override
    public void accept(ResourceVectorRecord resource) {
